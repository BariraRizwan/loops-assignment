...
let userGuess:any = [1,2,3,4,5,7,8,9,10];
let u = 1;
...
let myArray:number[] = [];
for(let newIncrement=1;newIncrement<=10;newIncrement++){
  let a = newIncrement - 1;
    console.log(`The value of index ${a} is ${myArray.push(newIncrement)}`);
}
